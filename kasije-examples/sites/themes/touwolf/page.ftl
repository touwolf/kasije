    ...
    <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="/resources/images/logo.png" alt="logo" width="128" height="49"></a>
            </div>
...
<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                &copy; ${.now?string["yyyy"]} ${page.@title}.
            </div>

            <div class="col-sm-6">
                <ul class="social-icons">
                    <#assign rssList = ["facebook", "twitter", "github"] />
                    <#list rssList as rss>
                        <li><a href="https://${rss}.com/touwolf" target="_blank"><i class="fa fa-${rss}"></i></a></li>
                    </#list>
                </ul>
            </div>
        </div>
